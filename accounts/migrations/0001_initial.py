    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_successful_clients', models.IntegerField(max_length=255, null=True)),
                ('rating', models.IntegerField(max_length=255, null=True)),
                ('contact_number_of_previous_client', models.IntegerField(max_length=30, null=True)),
                ('contractor_Img', models.ImageField(upload_to='Contractor_images/')),
